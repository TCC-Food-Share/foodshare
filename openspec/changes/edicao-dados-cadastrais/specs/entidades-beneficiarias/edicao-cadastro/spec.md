...
### Requirement: Campos não editáveis ignorados na edição da entidade beneficiária
...
- **THEN** o sistema aplica normalmente os campos editáveis válidos e mantém e-mail pessoal e CNPJ com o valor já cadastrado
