...
O sistema SHALL impedir o cadastro de uma entidade beneficiária quando o CNPJ, o e-mail institucional, o celular institucional, o e-mail pessoal ou o celular pessoal informados já pertencerem a outro cadastro, rejeitando a submissão e identificando todos os campos duplicados encontrados, sem criar nenhum registro (`Usuario`, `Endereco` ou `EntidadeBeneficiaria`).
...
- **WHEN** uma entidade beneficiária envia um cadastro em que o e-mail institucional e o celular pessoal já pertencem a outro cadastro
